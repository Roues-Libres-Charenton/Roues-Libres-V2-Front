...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({
      name: 'description',
      content:
        "Bienvenue sur le site de l'association Roues Libres de Charenton. Découvrez nos ateliers de co-réparation de vélos, nos évènements et nos actions pour promouvoir la pratique du vélo à Charenton-le-Pont.",
    });
  }
